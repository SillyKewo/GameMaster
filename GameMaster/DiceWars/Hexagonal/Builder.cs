...
namespace Hexagonal
{
    internal class Builder
    {
        public class BoardBuilder
        {
            ...
            private List<IDiceWarsPlayerLogic> playerLogics = null;
            ...
            public BoardBuilder withPlayerLogics(List<IDiceWarsPlayerLogic> playerLogics)
            {
            ...
            public Board build()
            {
                ...
                while (true)
                {
                    board = new Board(this.width, this.height, this.side, this.xOffset, this.yOffset, this.boardState, players);
                    bool islands = false;
